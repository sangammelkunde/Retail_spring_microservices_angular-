...
public class TransactionserviceApplication {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Transaction Micro Service", "The Transactions microservice will be responsible for performing all transactions within the Retal bank like Deposits, Withdrawal, Transfers. The service is responsible for checking business rules & propagating transaction contexts to Entities participating in the transaction. This service in turn will invoke behavior on the Account service ", "API", "Terms of service",
				new Contact("Vijayaram", "", ""), "License of API", "", Collections.emptyList());
	}
